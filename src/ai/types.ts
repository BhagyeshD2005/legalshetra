...
export const OrchestrationPlanSchema = z.object({
    plan: z.array(OrchestrationPlanStepSchema),
});
export type OrchestrationPlan = z.infer<typeof OrchestrationPlanSchema>;


export const OrchestrateStepInputSchema = z.object({
    step: OrchestrationPlanStepSchema,
    context: z.string().describe("The accumulated context from previous steps."),
});
export type OrchestrateStepInput = z.infer<typeof OrchestrateStepInputSchema>;
