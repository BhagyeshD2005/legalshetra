...
export type Mode = 'research' | 'analyzer' | 'reasoning' | 'drafting' | 'prediction';

export type AnalysisResult = GenerateLegalSummaryOutput | DocumentReviewResult | ReasoningResult | DraftResult | PredictiveAnalyticsResult | null;
