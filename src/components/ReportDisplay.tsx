...
export function ReportDisplay({ report, query }: ReportDisplayProps) {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      pdf.text("LegalshetraAI Report", margin, margin);
      ...
      pdf.save('LegalshetraAI-Report.pdf');
    } catch (error) {
  ...
  const handlePrint = () => {
    const printableContent = `
      <html>
        <head>
          <title>LegalshetraAI Report</title>
      ...
      <CardHeader>
        <div className="flex justify-between items-start flex-wrap gap-4">
            <div>
                ...
                <CardDescription>Generated by LegalshetraAI for your query.</CardDescription>
            </div>
